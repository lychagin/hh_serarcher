...
цикл переобогащения, которого больше не существует. Цикл (1) целиком
локальный, ограничен одним UPDATE и одним пересчётом на прогон и на
каждой итерации громко пишет в лог; цикл (2) невозможен — терминальный
статус выводит строку из всех выборок с первого раза.
"""
